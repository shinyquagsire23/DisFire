...
To compile, first create a single binary blob named 231C85toend.bin consisting of all data from 0x231C85 to the end of the Fire Red ROM. Then run compile.sh and the resulting ROM should be 
