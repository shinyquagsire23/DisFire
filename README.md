...
To compile, first create a single binary blob named 24FC40toend.bin consisting of all data from 0x24FC40 to the end of the Fire Red ROM. Then run compile.sh and the resulting ROM should be 
